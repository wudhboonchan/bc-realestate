...
const burmeseDict = {
    ...
    subBrand: 'ဘုန်းဂျန်းအိမ်ရာ (Boonchan)',
    ...
    thankYouMessage: 'ဘုန်းဂျန်းအိမ်ရာကို ရွေးချယ်သည့်အတွက် ကျေးဇူးတင်ပါသည်။',
...
export const dictionary: Record<LanguageOption, Record<string, string>> = {
  TH: {
    ...
    thankYouMessage: 'ขอบคุณที่ใช้บริการ หอพักบุญจันทร์',
