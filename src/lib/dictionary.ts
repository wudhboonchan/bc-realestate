...
const burmeseDict = {
    ...
    subBrand: 'ဘုန်းဂျန်း အပါတ်မန့် (တန်ဒေ)',
    ...
    thankYouMessage: 'ဘုန်းဂျန်း အပါတ်မန့် (တန်ဒေ) ကို ရွေးချယ်သည့်အတွက် ကျေးဇူးတင်ပါသည်။',
...
export const dictionary: Record<LanguageOption, Record<string, string>> = {
  TH: {
    ...
    subBrand: 'หอพักบุญจันทร์ (ตาลเดี่ยว)',
    ...
    thankYouMessage: 'ขอบคุณที่ใช้บริการ หอพักบุญจันทร์ (ตาลเดี่ยว)',
